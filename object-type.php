...
class CetakInfoProduk {
    public function cetak(Produk $produk) {
        // Agar supaya fungsi cetak ini menerima spesifik dari class produk sehingga Produk adalah (type nya) di gunakan untuk indetifikasi class produk yang di  Instantiasi.
